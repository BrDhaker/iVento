...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/deviceConnectPage',
          builder: (context, params) => NavBarPage(
            initialPage: '',
            page: DeviceConnectPageWidget(
        ...
        FFRoute(
          name: 'connectedDevicePage',
          path: '/connectedDevicePage',
          builder: (context, params) => ConnectedDevicePageWidget(
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'checkConnection')
        ...
        FFRoute(
          name: 'eventCreation',
          path: '/eventCreation',
          builder: (context, params) => EventCreationWidget(
