...
import 'device_connect_page_widget.dart' show DeviceConnectPageWidget;
import 'package:flutter/material.dart';

class DeviceConnectPageModel extends FlutterFlowModel<DeviceConnectPageWidget> {
  ...
  // Stores action output result for [Custom Action - getConnectedDevices] action in deviceConnectPage widget.
  List<BTDeviceStruct>? fetchedConnectedDevices;
  // Stores action output result for [Custom Action - findDevices] action in deviceConnectPage widget.
  ...
  List<BTDeviceStruct>? fetchedConnectedDevicesSwitchButton;
  // Stores action output result for [Custom Action - findDevices] action in Switch widget.
  List<BTDeviceStruct>? fetchedDevicesSwitchButton;
  ...
  List<BTDeviceStruct>? fetchedConnectedDevicesRefreshButton;
  // Stores action output result for [Custom Action - findDevices] action in Icon widget.
  List<BTDeviceStruct>? fetchedDevicesRefreshButton;
