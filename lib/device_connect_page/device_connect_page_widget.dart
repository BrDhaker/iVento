...
import 'device_connect_page_model.dart';
export 'device_connect_page_model.dart';

class DeviceConnectPageWidget extends StatefulWidget {
  const DeviceConnectPageWidget({
    super.key,
    bool? isBTEnabled,
  ...
  @override
  State<DeviceConnectPageWidget> createState() =>
      _DeviceConnectPageWidgetState();
}

class _DeviceConnectPageWidgetState extends State<DeviceConnectPageWidget>
    with TickerProviderStateMixin {
  late DeviceConnectPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DeviceConnectPageModel());
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              context.pushNamed('checkConnection');
            },
          ),
          title: Text(
                  ...
                  Switch.adaptive(
                    ...
                    onChanged: (newValue) async {
                      ...
                      if (newValue) {
                        ...
                        _model.isFetchingDevices = true;
                        setState(() {});
                        _model.fetchedConnectedDevicesSwitchButton =
                            await actions.getConnectedDevices();
                        _model.isFetchingConnectedDevices = false;
                        _model.connectedDevices = _model
                            .fetchedConnectedDevicesSwitchButton!
                            .toList()
                            .cast<BTDeviceStruct>();
                        setState(() {});
                        _model.fetchedDevicesSwitchButton =
                            await actions.findDevices();
                        _model.isFetchingDevices = false;
                        _model.foundDevices = _model.fetchedDevicesSwitchButton!
                            .toList()
                            .cast<BTDeviceStruct>();
                        setState(() {});
                                                ...
                                                InkWell(
                                                  ...
                                                  onTap: () async {
                                                    ...
                                                    _model.isFetchingDevices =
                                                        true;
                                                    setState(() {});
                                                    _model.fetchedConnectedDevicesRefreshButton =
                                                        await actions
                                                            .getConnectedDevices();
                                                    _model.isFetchingConnectedDevices =
                                                        false;
                                                    _model.connectedDevices = _model
                                                        .fetchedConnectedDevicesRefreshButton!
                                                        .toList()
                                                        .cast<BTDeviceStruct>();
                                                    setState(() {});
                                                    _model.fetchedDevicesRefreshButton =
                                                        await actions
                                                            .findDevices();
                                                    _model.isFetchingDevices =
                                                        false;
                                                    _model.foundDevices = _model
                                                        .fetchedDevicesRefreshButton!
                                                        .toList()
                                                        .cast<BTDeviceStruct>();
                                                    setState(() {});
