...
import 'connected_device_page_model.dart';
export 'connected_device_page_model.dart';

class ConnectedDevicePageWidget extends StatefulWidget {
  const ConnectedDevicePageWidget({
    super.key,
  ...
  @override
  State<ConnectedDevicePageWidget> createState() =>
      _ConnectedDevicePageWidgetState();
}

class _ConnectedDevicePageWidgetState extends State<ConnectedDevicePageWidget> {
  late ConnectedDevicePageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ConnectedDevicePageModel());
